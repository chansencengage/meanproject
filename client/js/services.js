...
app.factory('OfficeSuppliesService', ['$resource', '$location', function ($resource, $location) {
    ...
    var services = {
        ...
        update: function(officeSupply) {
            new resource(officeSupply).$save({id: officeSupply._id}).then(function(newOfficeSupply) {
        ...
        findSupplyById: function(id) {
            return _.findWhere(services.officeSupplies, {"_id": id});
        }
    };
