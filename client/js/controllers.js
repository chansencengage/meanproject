...
app.controller('OfficeSupplies', ['$scope', 'OfficeSuppliesService', function ($scope, OfficeSuppliesService) {
    $scope.officeSupplies = OfficeSuppliesService.officeSupplies;
}]);

app.controller('AddOfficeSupply', ['$scope', 'OfficeSuppliesService', function ($scope, OfficeSuppliesService) {
    $scope.officeSupply = {};
...
app.controller('EditOfficeSupply', ['$scope', '$routeParams', 'OfficeSuppliesService', function ($scope, $routeParams, OfficeSuppliesService) {
